...
score = np.array([[1, initOnset,
                      noteToNumber("B", 5), 120, qNote],
                 [1, initOnset+qNote,
                      noteToNumber("F#", 3), 100, qNote],
...
#         print(gate)
    ...
    outputFileName = "wav/orion-treble-bmajor-" + instrument +".wav"
