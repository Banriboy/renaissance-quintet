...
score = np.array([[1, initOnset,
                      noteToNumber("C#", 5), 120, qNote],
                 [1, initOnset+qNote,
                      noteToNumber("G#", 2), 100, qNote],
...
#         print(gate)
    ...
    outputFileName = "wav/orion-alto-bmajor-" + instrument +".wav"
